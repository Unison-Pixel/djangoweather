...
def home(request):
	...
	if request.method == "POST":
		...
		api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" + zipcode + "&distance=5&API_KEY=967C7B17-1770-4019-81AC-6F24F695F595")
		...
		# 16/1/2020 (jueves): Muevo las descripciones de las categorias de clima
		# del archivo home.html a views.py
		...
		api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=89129&distance=5&API_KEY=967C7B17-1770-4019-81AC-6F24F695F595")
